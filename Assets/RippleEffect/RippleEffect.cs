...
public class RippleEffect : MonoBehaviour
{
    ...
    void UpdateShaderParameters()
    {
        ...
        material.SetVector("_Drop0", droplets[0].MakeShaderParameter(c.aspect));
        material.SetVector("_Drop1", droplets[1].MakeShaderParameter(c.aspect));
        material.SetVector("_Drop2", droplets[2].MakeShaderParameter(c.aspect));
        material.SetVector("_Drop3", droplets[3].MakeShaderParameter(c.aspect));
        material.SetVector("_Drop4", droplets[4].MakeShaderParameter(c.aspect));
        material.SetVector("_Drop5", droplets[5].MakeShaderParameter(c.aspect));
        material.SetVector("_Drop6", droplets[6].MakeShaderParameter(c.aspect));
        material.SetVector("_Drop7", droplets[7].MakeShaderParameter(c.aspect));
        material.SetVector("_Drop8", droplets[8].MakeShaderParameter(c.aspect));
        material.SetVector("_Drop9", droplets[9].MakeShaderParameter(c.aspect));
